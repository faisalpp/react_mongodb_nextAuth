     ...
     <div className='flex items-center bg-c1 shadow-md mb-2 p-3'>
      ...
      <div className='flex justify-end space-x-5 w-full font-semibold'>
       <div className='flex space-x-10 items-center'>
        ...
        <Link href={'/Categories/Libraries'} ><h3 className='text-c4 hover:border-b-2 hover:border-c3 hover:text-c3 hover:py-0.5 cursor-pointer'>Libraries</h3></Link>
        <Link href={'/Categories/Blog'}><h3 className='text-c4 hover:border-b-2 hover:border-c3 hover:text-c3 hover:py-0.5 cursor-pointer'>Blog</h3></Link>
